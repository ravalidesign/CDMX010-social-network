...
<input class="form" type="text" name="nombre" id="emaillogin" placeholder="Ingrese Correo">
<input class="form" type="password" name="nombre" id="passwordlogin" placeholder="Ingrese Contraseña">
</form>
